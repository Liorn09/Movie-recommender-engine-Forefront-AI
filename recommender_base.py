...
def main():
    ...
    with st.sidebar:
        st.write('**ForeFront AI**')
        from PIL import Image
        image2= Image.open('resources/imgs/logo2.jpg')
        st.image(image2, caption='ForeFront Intelligence')

        page_selection = option_menu(
            menu_title=None,
            options=["Recommender System", "Movie Information", "EDA", "Team", "Solution Overview"],
            menu_icon='cast',
            default_index=0,
    ...
    if page_selection == "Team":
        ...
        with col9:
            ...
            st.image("resources/imgs/mandy.jpeg")
        ...
        col11.write("**Data Engineer**")
        with col11:
            st.markdown("""

           "Experienced, results-oriented, resourceful, and problem-solving Data engineer with leadership skills. Adapt and met the challenges of tight release dates. Over 2 years of diverse experience in the Information Technology field, includes Development, and Implementation of various applications in big data and Mainframe environments."

               """)

        col12.write("**Adetayo Tella**")
        with col12:
...
With this context, EDSA is challenging US, ForeFront AI, to construct a recommendation algorithm based on content or collaborative filtering, capable of accurately predicting how a user will rate a movie they have not yet viewed, based on their historical preferences.
